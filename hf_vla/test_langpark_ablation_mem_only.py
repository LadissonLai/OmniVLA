...
class TestLangParkMemOnlyConfig:
    ...
    resume_dir:  str = "/root/autodl-tmp/codes/OmniVLA/runs/runs_langpark_ablation_mem_only/2026-06-17_12-19/step_6424_loss_0.0102_ckpt"   # set to the ablation_mem_only checkpoint dir
